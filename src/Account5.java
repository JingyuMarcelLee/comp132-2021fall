...
public class Account5 {
	...
	public int computeInterest(int period) {
		int interestAmount = interestRate * balance / 100 / period;
		return interestAmount;
	}
	
	public int computeQuarterlyInterest() {
		int interestAmount = computeInterest(4);
		return interestAmount;
	}

	public void addInterest() {
		int interestAmount =computeInterest(1);
